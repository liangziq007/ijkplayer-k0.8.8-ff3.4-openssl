...
$CC -lm -lz -shared --sysroot=$FF_SYSROOT -Wl,--no-undefined -Wl,-z,noexecstack $FF_EXTRA_LDFLAGS \
    -Wl,-soname,libijkplayer-ffmpeg.so \
    $FF_C_OBJ_FILES \
    $FF_ASM_OBJ_FILES \
    $FF_DEP_LIBS \
    -o $FF_PREFIX/libijkplayer-ffmpeg.so
...
ln -s $FF_PREFIX/libijkplayer-ffmpeg.so $FF_PREFIX/shared/lib/libijkplayer-ffmpeg.so
...
for f in $FF_PREFIX/lib/pkgconfig/*.pc; do
    ...
    mysedi $f 's/-lavcodec/-lijkplayer-ffmpeg/g'
    mysedi $f 's/-lavfilter/-lijkplayer-ffmpeg/g'
    mysedi $f 's/-lavformat/-lijkplayer-ffmpeg/g'
    mysedi $f 's/-lavutil/-lijkplayer-ffmpeg/g'
    mysedi $f 's/-lswresample/-lijkplayer-ffmpeg/g'
    mysedi $f 's/-lswscale/-lijkplayer-ffmpeg/g'
done
